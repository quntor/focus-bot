...
| Возвращение | 5 очков за первую засчитанную сессию после пропуска от 3 дней, не закрытого заморозкой; не чаще раза в 14 дней |
...
| Заморозка | запас до 2, +1 за каждые 7 дней серии; пропуск длиннее запаса рвёт серию и запас не тратит |
